...
public class PaymentService {
	...
	//HystrixCommand 会使用单独的线程池去处理
	@HystrixCommand(fallbackMethod = "paymentInfo_TimeOutHandler", commandProperties = {
			@HystrixProperty(name="execution.isolation.thread.timeoutInMilliseconds",value="5000") //这个线程的超时时间，3秒走正常的；逻辑
	})
	public String paymentInfo_TimeOut(Integer id)
	{
//		int age = 10 / 0;
		int timeOut = 3000; //3000 5000
